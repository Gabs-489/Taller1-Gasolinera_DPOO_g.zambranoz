...
public class SandboxConjuntos
{
    ...
    {
    	List<String> cadenas = new ArrayList<String>(arbolCadenas.size());
    ...
    {
    	Collection<String> sig = arbolCadenas.tailSet(cadena);
        return 	sig;
    }
    ...
    {
    	String e = cadena.toLowerCase();
    	arbolCadenas.remove(e);
    	String b = cadena.toUpperCase();
    	arbolCadenas.remove(b);
    }
    ...
    public void reiniciarConjuntoCadenas( List<Object> objetos )
    {
    	...
    	for (Iterator<Object> iterator = objetos.iterator(); iterator.hasNext();)
    	{
    		...
    		String cad = val.toString();
    		arbolCadenas.add(cad);
    	}
    ...
    {
    	NavigableSet<String> nueva = new TreeSet<String>();
    	for(String c:arbolCadenas) {
    		c=c.toUpperCase();
    		nueva.add(c);
    	}
    ...
    {
    	TreeSet<String> nueva =new TreeSet<>(Comparator.reverseOrder());
    	for(String c:arbolCadenas) {
    		nueva.add(c);
    	}
        return nueva;
    ...
    public boolean compararElementos( String[] otroArreglo )
    {
    	for(String c :otroArreglo) {
    		if (arbolCadenas.contains(c)==false) {
    		return false;
    		}
    	}
        return true;
